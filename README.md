...
| `--indexSpecIgnore` | Makes logs ignore index matches around the given index-specification fields. Allowed values are: [`expireAfterSeconds`, `unique`] (comma separated) |
